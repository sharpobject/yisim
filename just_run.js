...
if (process.argv.length < 3) {
  ...
  jsonData.a.cards = jsonData.a.cards.slice(0, 8);
  jsonData.b.cards = jsonData.b.cards.slice(0, 8);
} else {
  db.connectForRead();
  ...
  jsonData.a.cards = [result.A1, result.A2, result.A3, result.A4, result.A5, result.A6, result.A7, result.A8].map((i) => ('' + i));
  jsonData.b.cards = [result.B1, result.B2, result.B3, result.B4, result.B5, result.B6, result.B7, result.B8].map((i) => ('' + i));
}
