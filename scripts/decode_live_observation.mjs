...
function decodePublicData(bytes) {
  ...
  const publicData = {
    ...
    enlightenedCards: Object.fromEntries(values(fields, 22).map(mapIntBattleTalentData))[189]?.commonParams ?? [],
  ...
  if (lastRound) {
    ...
    publicData.lastRound = {
      ...
      enlightenedCards: Object.fromEntries(values(lastFields, 12).map(mapIntBattleTalentData))[189]?.commonParams ?? [],
